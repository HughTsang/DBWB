...
class HZLabel: UILabel {
    ...
    public typealias HZTapHandler = (HZLabel, String, NSRange) -> Void
    public var linkTapHandler : HZTapHandler?
    public var topicTapHandler : HZTapHandler?
    public var userTapHandler : HZTapHandler?
